...
const SOURCE_LABELS: Record<string, string> = {
  ...
  CANADA_ONE: "CanadaOne directory",
...
export default async function CampaignDetailPage({
  ...
  const automated = campaign.connectorType === "OSM" || campaign.connectorType === "CANADA_ONE";
  ...
  return (
    <div>
        ...
        {automated && (
          <form action={runOsmDiscoveryAction.bind(null, campaign.id)}>
            <button type="submit" className="btn-primary">
              Run {campaign.connectorType === "CANADA_ONE" ? "CanadaOne" : "OpenStreetMap"} discovery
            </button>
          </form>
        )}
      ...
      {campaign.connectorType === "GOV_DIRECTORY" && (
        <p className="empty-state">This legacy campaign references a government connector that has not been configured.</p>
      )}
